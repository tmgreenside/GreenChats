...
exports.displayNewsFeed = function(req, res) {
    ...
    mediaPosts = "SELECT M.postID, M.type, M.filePath FROM PostMedia as M, Posts as P WHERE P.id = M.PostID AND P.profile IN (SELECT profile2 FROM Friendships WHERE profile1 = ?) OR P.profile = ?";
